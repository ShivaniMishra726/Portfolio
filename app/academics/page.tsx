  ...
  return (
    <PageTransition>
      <div className="min-h-screen pt-24 pb-16 px-4 max-w-7xl mx-auto">
        ...
        >
          <h3 className="font-heading font-semibold text-lg text-gray-900 dark:text-white mb-6">
            Semester Breakdown
          </h3>
          <div className="space-y-4">
            {academicData.map((sem, i) => (
              ...
              >
                <div className="w-16 text-sm font-semibold text-gray-700 dark:text-gray-300 shrink-0">
                  {sem.semester}
                </div>
                <div className="flex-1 h-8 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    className="h-full bg-gradient-to-r from-primary-500 to-purple-400 rounded-full flex items-center justify-end pr-3"
                  >
                    <span className="text-xs font-bold text-white">{sem.sgpa}</span>
                  </motion.div>
                </div>
              </motion.div>
            ))}
